...
Revision ID: a652bfce889e
Revises: ac1a3e5c37c7
Create Date: 2022-07-14 16:55:31.741758
...
revision = 'a652bfce889e'
down_revision = 'ac1a3e5c37c7'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('library_cognito', sa.Boolean(), nullable=True),
    ...
    sa.Column('book_cognito', sa.Boolean(), nullable=True),
